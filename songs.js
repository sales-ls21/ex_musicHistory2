...
//writing string to the div on the HTML

var insert = document.getElementById("maincontent");

insert.innerHTML = "<div>" + songs[0] + "</div>" + "<div>" + songs[1] + "</div>" + "<div>" + songs[2] + "</div>"
+ "<div>" + songs[3] + "</div>" + "<div>" + songs[4] + "</div>" + "<div>" + songs[5] + "</div>" + "<div>" + songs[6] + "</div>";
